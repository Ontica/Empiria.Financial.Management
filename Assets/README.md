...
Este repositorio contiene los módulos del *backend* del **Sistema de administración del activo fijo**.
...
El *backend* del **Sistema de administración del activo fijo** se conforma de los siguientes módulos:
