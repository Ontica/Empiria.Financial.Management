# Empiria Billing System

Este repositorio contiene los módulos del *backend* del **Sistema de administración de la facturación**.
...
El *backend* del **Sistema de administración de la facturación** se conforma de los siguientes módulos:
